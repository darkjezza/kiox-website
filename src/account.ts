...
import { el, HOME_URL, PLAY_URL, topBarHtml } from "./siteChrome";
import "./style.css";
...
function renderManager(
  ...
  root.innerHTML = `
    ...
    <p class="lede account-lede">Change account details and manage characters. Use <a href="${PLAY_URL}">Play</a> to enter the game.</p>
    <div id="account-flash"></div>
