...
export const ACCOUNT_URL = import.meta.env.VITE_ACCOUNT_PAGE || "/account";
export const SHOP_URL = import.meta.env.VITE_SHOP_PAGE || "/shop";
export const ITEMS_URL = import.meta.env.VITE_ITEMS_PAGE || "/items";
export const GUILDS_URL = import.meta.env.VITE_GUILDS_PAGE || "/guilds";
...
export type NavActive = "home" | "play" | "account" | "shop" | "items" | "guilds" | "community" | "";
  ...
  return `
    <header class="top">
      ...
      <nav class="nav">
        ...
        ${navLink(SHOP_URL, "Shop", active === "shop")}
...
export function footerHtml(): string {
  ...
  return `
    <footer class="footer">
      <p>© ${y} Kiox Online · <a href="${PLAY_URL}">Play</a> · <a href="${ACCOUNT_URL}">Account</a> · <a href="${SHOP_URL}">Shop</a> · <a href="${ITEMS_URL}">Items</a> · <a href="${GUILDS_URL}">Guilds</a> · Data: database + live server</p>
